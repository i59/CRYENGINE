...
protected:
	...
	//static tSoundID PlaySound(IEntityAudioComponent& rIEntityAudioProxy, const char* soundName);
	//static void SetSoundParam(IEntityAudioComponent& rIEntityAudioProxy, tSoundID soundID, const char* param, float value);
	//static void StopSound(IEntityAudioComponent& rIEntityAudioProxy, tSoundID soundID);
	IVehicle*                  m_pVehicle;
