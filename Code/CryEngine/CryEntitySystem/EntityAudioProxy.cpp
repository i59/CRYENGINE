...
CEntityAudioComponent::TAudioProxyPair CEntityAudioComponent::s_nullAudioProxyPair(INVALID_AUDIO_PROXY_ID, static_cast<IAudioProxy*>(nullptr));
CAudioObjectTransformation CEntityAudioComponent::s_audioListenerLastTransformation;

//////////////////////////////////////////////////////////////////////////
CEntityAudioComponent::CEntityAudioComponent()
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::OnMove()
{
	CRY_ASSERT_MESSAGE(!(((m_flags & eEAPF_CAN_MOVE_WITH_ENTITY) > 0) && ((m_pEntity->GetFlagsExtended() & ENTITY_FLAG_EXTENDED_AUDIO_LISTENER) > 0)), "An CEntityAudioComponent cannot have both flags (eEAPF_CAN_MOVE_WITH_ENTITY & ENTITY_FLAG_EXTENDED_AUDIO_LISTENER) set simultaneously!");

	Matrix34 const& tm = m_pEntity->GetWorldTM();
	CRY_ASSERT_MESSAGE(tm.IsValid(), "Invalid Matrix34 during CEntityAudioComponent::OnMove");
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::OnListenerMoveInside(Vec3 const& listenerPos)
{
	m_pEntity->SetPos(listenerPos);
}

//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::OnListenerExclusiveMoveInside(IEntity const* const __restrict pEntity, IEntity const* const __restrict pAreaHigh, IEntity const* const __restrict pAreaLow, float const fade)
{
	auto *pAreaProxyLow = pAreaLow->QueryComponent<IEntityAreaComponent>();
	auto *pAreaProxyHigh = pAreaHigh->QueryComponent<IEntityAreaComponent>();
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::OnListenerEnter(IEntity const* const pEntity)
{
	m_pEntity->SetPos(pEntity->GetWorldPos());
}

//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::OnListenerMoveNear(Vec3 const& closestPointToArea)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::Serialize(TSerialize ser)
{
}

//////////////////////////////////////////////////////////////////////////
bool CEntityAudioComponent::PlayFile(SAudioPlayFileInfo const& playbackInfo, AudioProxyId const audioProxyId /* = DEFAULT_AUDIO_PROXY_ID */, SAudioCallBackInfo const& callBackInfo /* = SAudioCallBackInfo::GetEmptyObject() */)
{
	if (m_pEntity != nullptr)
	{
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::StopFile(
...
//////////////////////////////////////////////////////////////////////////
bool CEntityAudioComponent::ExecuteTrigger(
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::StopTrigger(AudioControlId const audioTriggerId, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetSwitchState(AudioControlId const audioSwitchId, AudioSwitchStateId const audioStateId, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetRtpcValue(AudioControlId const audioRtpcId, float const value, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetObstructionCalcType(EAudioOcclusionType const occlusionType, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetEnvironmentAmount(AudioEnvironmentId const audioEnvironmentId, float const amount, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetCurrentEnvironments(AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
		TAudioProxyPair const& audioProxyPair = GetAuxAudioProxyPair(audioProxyId);
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::AuxAudioProxiesMoveWithEntity(bool const bCanMoveWithEntity)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::AddAsListenerToAuxAudioProxy(AudioProxyId const audioProxyId, void (* func)(SAudioRequestInfo const* const), EAudioRequestType requestType /*= eAudioRequestType_AudioAllRequests*/, AudioEnumFlagsType specificRequestMask /*= ALL_AUDIO_REQUEST_SPECIFIC_TYPE_FLAGS*/)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::RemoveAsListenerFromAuxAudioProxy(AudioProxyId const audioProxyId, void (* func)(SAudioRequestInfo const* const))
{
	TAuxAudioProxies::const_iterator const iter(m_mapAuxAudioProxies.find(audioProxyId));
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetAuxAudioProxyOffset(Matrix34 const& offset, AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	if (audioProxyId != INVALID_AUDIO_PROXY_ID)
	{
...
//////////////////////////////////////////////////////////////////////////
Matrix34 const& CEntityAudioComponent::GetAuxAudioProxyOffset(AudioProxyId const audioProxyId /*= DEFAULT_AUDIO_PROXY_ID*/)
{
	TAuxAudioProxies::const_iterator const iter(m_mapAuxAudioProxies.find(audioProxyId));
...
//////////////////////////////////////////////////////////////////////////
float CEntityAudioComponent::GetGreatestFadeDistance() const
{
	return std::max<float>(m_fadeDistance, m_environmentFadeDistance);
}

//////////////////////////////////////////////////////////////////////////
AudioProxyId CEntityAudioComponent::CreateAuxAudioProxy()
{
	...
	if ((m_pEntity->GetFlagsExtended() & ENTITY_FLAG_EXTENDED_AUDIO_LISTENER) == 0)
	{
		...
		if (pIAudioProxy != nullptr)
		{
			...
			{
				CryFatalError("<Audio> Exceeded numerical limits during CEntityAudioComponent::CreateAudioProxy!");
			}
			else if (m_pEntity == nullptr)
			{
				CryFatalError("<Audio> nullptr entity pointer during CEntityAudioComponent::CreateAudioProxy!");
			}
...
//////////////////////////////////////////////////////////////////////////
bool CEntityAudioComponent::RemoveAuxAudioProxy(AudioProxyId const audioProxyId)
{
	bool bSuccess = false;
	...
	if (audioProxyId != DEFAULT_AUDIO_PROXY_ID)
	{
		...
		{
			gEnv->pSystem->Warning(VALIDATOR_MODULE_ENTITYSYSTEM, VALIDATOR_WARNING, VALIDATOR_FLAG_AUDIO, 0, "<Audio> AuxAudioProxy with ID '%u' not found during CEntityAudioComponent::RemoveAuxAudioProxy (%s)!", audioProxyId, m_pEntity->GetEntityTextDescription().c_str());
			assert(false);
		}
	}
	else
	{
		gEnv->pSystem->Warning(VALIDATOR_MODULE_ENTITYSYSTEM, VALIDATOR_ERROR, VALIDATOR_FLAG_AUDIO, 0, "<Audio> Trying to remove the default AudioProxy during CEntityAudioComponent::RemoveAuxAudioProxy (%s)!", m_pEntity->GetEntityTextDescription().c_str());
		assert(false);
	}
...
//////////////////////////////////////////////////////////////////////////
CEntityAudioComponent::TAudioProxyPair& CEntityAudioComponent::GetAuxAudioProxyPair(AudioProxyId const audioProxyId)
{
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioComponent::SetEnvironmentAmountInternal(IEntity const* const pIEntity, float const amount) const
{
	...
	if (pIEntity != nullptr && m_pEntity != nullptr && pIEntity != m_pEntity)
	{
		...
		{
			if ((m_audioEnvironmentId != INVALID_AUDIO_ENVIRONMENT_ID))
			{
				...
				pAudioComponent->SetEnvironmentAmount(m_audioEnvironmentId, amount, INVALID_AUDIO_PROXY_ID);
			}
		}
	}
}
