...
class CDefaultEntityPropertyHandler
...
public:
	...
	CDefaultEntityPropertyHandler(IEntityPropertyHandler::SPropertyInfo *pProperties, int numProperties, uint32 scriptFlags);
	virtual ~CDefaultEntityPropertyHandler();
